pipeline {
    ...
    parameters {
        ...
        choice(name: 'GITHUB_REPO', choices: ['magestore-shark/pos-enterprise', 'magestore-shark/pos-pro', 'Magestore/pos-standard', 'Magestore/pos-pro', 'Magestore/pos-enterprise'], description: 'Github repository')
